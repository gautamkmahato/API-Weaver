    ...
    <section id="support" className="bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-4">
          {/* Documentation */}
          <div className="bg-neutral-100 rounded-xl p-6 animate__animated animate__fadeInUp">
          ...
          {/* Community */}
          <div className="bg-neutral-100 rounded-xl p-6 animate__animated animate__fadeInUp" style={{ animationDelay: '0.2s' }}>
          ...
          {/* Direct Support */}
          <div className="bg-neutral-100 rounded-xl p-6 animate__animated animate__fadeInUp" style={{ animationDelay: '0.4s' }}>
